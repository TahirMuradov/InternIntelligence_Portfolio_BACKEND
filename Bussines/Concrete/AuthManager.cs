  ...
  public  class AuthManager:IAuthService
   ...
   token: token
        ...
        public async Task<IResult> RegisterAsync(RegisterDTO registerDTO)
        {
            ...
            var checkEmail = _userManager.Users.FirstOrDefault(x => x.Email == registerDTO.Email);
            ...
            if (identityResult.Succeeded)
            {
                ...
                string confimationLink = $"{_configuration["Domain:Front"]}/auth/emailconfirmed/{HttpUtility.UrlEncode(newUser.Email)}/{HttpUtility.UrlEncode(token)}";
